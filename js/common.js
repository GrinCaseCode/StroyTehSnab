...
if ( $(this).scrollTop() > 0 && $menu.hasClass("default") ){
	...
	$(".link-page_checkbox").click(function(e) {
		e.preventDefault();
		if ($(this).siblings(".checkbox:nth-child(n+6)").is(":hidden")) {
			$(this).siblings(".checkbox:nth-child(n+6)").slideDown(200);
			$(this).html("Свернуть"); 
		} else {
			$(this).siblings(".checkbox:nth-child(n+6)").slideUp(200);
	...
	$(".btn-catalog").click(function() {
		if ($(".nav-catalog").is(":hidden")) {
			$(".nav-catalog").slideDown(200);
			$(this).find(".sandwich").addClass("active");
			$(this).addClass("active");
		} else {
			$(".nav-catalog").slideUp(200);
...

	{
		if ($(window).width() < 992) { 
			...
			$(".item-header i").click(function() {
				if ($(this).siblings(".item-header__dropdown").is(":hidden")) {
					$(this).siblings(".item-header__dropdown").slideDown(200);
					$(this).addClass("active");
				} else {
					$(this).siblings(".item-header__dropdown").slideUp(200);
					$(this).removeClass("active");
				}
			});
		}
